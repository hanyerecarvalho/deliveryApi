...
use Api\Routes\ClienteRouter;
use Api\Routes\ItensPedidoRouter;
use Api\Routes\PedidosRouter;
use Api\Routes\ProdutosRouter;
use Api\Routes\RestaurantesRouter;
...
class Server
{
    ...
    private ItensPedidoRouter $itensPedidoRouter;

    private PedidosRouter $pedidosRouter;

    private ProdutosRouter $produtosRouter;

    private RestaurantesRouter $restaurantesRouter;
     ...
     * @param  $cargoRouter Router para rotas de cargos (injetado pelo Container)
     * @param  $funcionarioRouter Router para rotas de funcionários (injetado pelo Container)
     */
    public function __construct(
        App $app,
        ClienteRouter $clienteRouter,
        ItensPedidoRouter $itensPedidoRouter,
        PedidosRouter $pedidosRouter,
        ProdutosRouter $produtosRouter,
        RestaurantesRouter $restaurantesRouter
    ) {
        // Armazena as dependências recebidas nas propriedades privadas da classe
        $this->app = $app;
        $this->clienteRouter = $clienteRouter;
        $this->itensPedidoRouter = $itensPedidoRouter;
        $this->pedidosRouter = $pedidosRouter;
        $this->produtosRouter = $produtosRouter;
        $this->restaurantesRouter = $restaurantesRouter;
    ...
    private function setupRoutes(): void
    {
        ...
        $this->clienteRouter->setupRoutes();  // Rotas para /cargos/*
        ...
        $this->itensPedidoRouter->setupRoutes();  // Rotas para /funcionarios/*
        $this->pedidosRouter->setupRoutes();
        $this->produtosRouter->setupRoutes();
        $this->restaurantesRouter->setupRoutes();
