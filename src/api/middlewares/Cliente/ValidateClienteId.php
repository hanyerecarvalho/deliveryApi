...
namespace Api\Middlewares\Cliente;
 ...
 */
class ValidateClienteId implements MiddlewareInterface
{
    /**
    ...
    public function process(Request $request, RequestHandler $handler): Response
    {
        ...
        // -----------------------------------------------------------
        if (!isset($routeArgs['idCliente']) || $routeArgs['idCliente'] === "") {
            throw new ErrorResponse(
                httpCode: 400,
                message: "Erro na validação de dados",
                error: [
                    "message" => "O parâmetro 'idCliente' é obrigatório!"  // Mensagem detalhada
                ]
            );
        }
